...
{
    const char* pszTimestamp = "2022/2/14 But Game Coin will be used in many games!";
...
public:
    CMainParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 1047200;
        ...
        consensus.smartnodePaymentFixedBlock = 500;
        ...
        consensus.defaultAssumeValid = uint256S("0x0000112eb451fbdf5e8b5c588c0912b3e70e2ea5a37ac88e4ca8c1ad27279509"); // 153
        ...
        pchMessageStart[1] = 0x67;//g
        pchMessageStart[2] = 0x62;//b
        pchMessageStart[3] = 0x2e;//.
        nDefaultPort = 58888;
        nPruneAfterHeight = 100000;
        //FindMainNetGenesisBlock(1644821084, 0x20001fff, "main");
        genesis = CreateGenesisBlock(1644821084, 1199, 0x20001fff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000b735daa76ad416f6a63eca8ac878af013e87a332236b9d59c5c9aa4c0fcdd"));
        assert(genesis.hashMerkleRoot == uint256S("0x3e3ec120810b368b583d195847babef3d366237957f1e22e4be125cf0c9ca0a3"));

        vSeeds.emplace_back("s1.bgcoin.top","s1.bgcoin.top");
        vSeeds.emplace_back("s2.bgcoin.top","s2.bgcoin.top");
        vSeeds.emplace_back("s3.bgcoin.top","s3.bgcoin.top");
        vSeeds.emplace_back("s4.bgcoin.top","s4.bgcoin.top");
        vSeeds.emplace_back("s5.bgcoin.top","s5.bgcoin.top");
        vSeeds.emplace_back("s6.bgcoin.top","s6.bgcoin.top");
        vSeeds.emplace_back("s7.bgcoin.top","s7.bgcoin.top");
        vSeeds.emplace_back("s8.bgcoin.top","s8.bgcoin.top");
        vSeeds.emplace_back("s9.bgcoin.top","s9.bgcoin.top");
        vSeeds.emplace_back("s10.bgcoin.top","s10.bgcoin.top");
        vSeeds.emplace_back("s1.yeji.in","s1.yeji.in");
        vSeeds.emplace_back("s2.yeji.in","s2.yeji.in");
        vSeeds.emplace_back("s3.yeji.in","s3.yeji.in");
        vSeeds.emplace_back("s4.yeji.in","s4.yeji.in");
        vSeeds.emplace_back("s5.yeji.in","s5.yeji.in");
        vSeeds.emplace_back("s6.yeji.in","s6.yeji.in");
        vSeeds.emplace_back("s7.yeji.in","s7.yeji.in");
        vSeeds.emplace_back("s8.yeji.in","s8.yeji.in");
        vSeeds.emplace_back("s9.yeji.in","s9.yeji.in");
        vSeeds.emplace_back("s10.yeji.in","s10.yeji.in");
        // But addresses start with 'G'
        ...
        consensus.nCollaterals = SmartnodeCollaterals(
			{
                {88720, 5000000 * COIN}, {176720, 10000000 * COIN},
                {264720, 15000000 * COIN}, {INT_MAX, 18000000 * COIN}
			},
			{
				{500, 0}, {INT_MAX, 20}
			}
        ...
        vSporkAddresses = {"GfYNeDUVFCYN1Byv4FpTeWhz9eXXchazVF"};
        nMinSporkKeys = 1;
        fBIP9CheckSmartnodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            {
                {0,     uint256S("0x000b735daa76ad416f6a63eca8ac878af013e87a332236b9d59c5c9aa4c0fcdd")},
...
public:
	...
	consensus.DGWBlocksAvg = 60;
        ...
        //FindMainNetGenesisBlock(1644821084,  0x20001fff, "test");
        genesis = CreateGenesisBlock(1644821084, 1199, 0x20001fff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000b735daa76ad416f6a63eca8ac878af013e87a332236b9d59c5c9aa4c0fcdd"));
        assert(genesis.hashMerkleRoot == uint256S("0x3e3ec120810b368b583d195847babef3d366237957f1e22e4be125cf0c9ca0a3"));
        ...
        vSeeds.emplace_back("testnet.bgcoin.top", true);
